...
<?php else: ?>
<link rel="stylesheet" href="<?php echo e(asset('vendor/css/pages/app-chat.css')); ?>" />
				...
				<a class="d-flex align-items-center">
				  ...
				  <div class="chat-contact-info flex-grow-1 ms-4 text-truncate">
					...
					<small class="chat-contact-status">
					  <?php echo e(__($session->last_message)); ?>
...
<script type="module" src="<?php echo e(asset('js/emoji/picker.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/app-chat.js')); ?>"></script>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /www/wwwroot/blas2.codeteam.id/resources/themes/vuexy/views/pages/chat.blade.php ENDPATH**/ ?>
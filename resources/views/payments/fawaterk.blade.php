...
<body>
	<div class="container">
        <div class="payment-container">
            ...
            <button id="pay-button" class="btn btn-primary w-100">{{ __('Pay with Fawaterk') }}</button>
        </div>
    </div>
    <script>
        document.getElementById('pay-button').addEventListener('click', function() {
            window.location.href = "{{ route('payments.process', ['planId' => $plan->id]) }}?payment_gateway=fawaterk";
        });
    </script>
</body>
</html>

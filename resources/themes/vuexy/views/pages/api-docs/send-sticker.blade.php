...
<pre class="bg-dark rounded text-white"><code class="json">{{ url('/') }}/send-sticker?api_key=1234567890&sender=62888xxxx&number=62888xxxx&url=https://example.com/image.jpg</code></pre>
